        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    // 结果容器 - 改为ScrollView包裹LinearLayout
                    ...
                    resultContainer.setPadding(dpToPx(activity, 8), dpToPx(activity, 8), dpToPx(activity, 8), dpToPx(activity, 8));
